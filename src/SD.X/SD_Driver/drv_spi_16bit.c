...
void DRV_SPI_PutBuffer(uint8_t channel, uint8_t * data, unsigned int count)
{
    uint8_t dataByte;
#ifndef DRV_SPI_CONFIG_ENHANCED_BUFFER_DISABLE
    unsigned int originalLength = count;
#endif
...
void DRV_SPI_GetBuffer(uint8_t channel, uint8_t * data, unsigned int count)
{
#ifndef DRV_SPI_CONFIG_ENHANCED_BUFFER_DISABLE
    unsigned int originalLength = count;
#endif
